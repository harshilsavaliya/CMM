<%@ Page Title="Unit View" Language="C#" MasterPageFile="~/CMMWeb/MasterPage/CMMMasterPage.master" AutoEventWireup="true" CodeFile="UnitView.aspx.cs" Inherits="CMMWeb_AdminPanel_Unit_UnitView" %>
                    ...
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <asp:Label runat="server" Text="UNIT VIEW"></asp:Label>
                            </div>
                            <div class="tools">
